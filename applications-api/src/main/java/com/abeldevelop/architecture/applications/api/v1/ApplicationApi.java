...
public interface ApplicationApi {
	...
	public ApplicationResponseResource executeCreate(@ApiParam(name="errorMessage", value="application to create", required = true) @RequestBody CreateApplicationRequestResource createApplicationRequestResource);
    ...
    public void executeDelete(@ApiParam(name="id", value="ID of the application", required = true, example="1") @PathVariable("id") Long id);
    ...
    @GetMapping("/{id}")
    @ResponseStatus(HttpStatus.OK)
    public ApplicationResponseResource executeFindById(@ApiParam(name="id", value="ID of the application", required = true, example="1") @PathVariable("id") Long id);
